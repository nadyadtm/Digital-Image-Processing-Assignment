function varargout = Tugas_PCD_Akhir_nadyaaditama_1301154556(varargin)
% TUGAS_PCD_AKHIR_NADYAADITAMA_1301154556 MATLAB code for Tugas_PCD_Akhir_nadyaaditama_1301154556.fig
%      TUGAS_PCD_AKHIR_NADYAADITAMA_1301154556, by itself, creates a new TUGAS_PCD_AKHIR_NADYAADITAMA_1301154556 or raises the existing
%      singleton*.
%
%      H = TUGAS_PCD_AKHIR_NADYAADITAMA_1301154556 returns the handle to a new TUGAS_PCD_AKHIR_NADYAADITAMA_1301154556 or the handle to
%      the existing singleton*.
%
%      TUGAS_PCD_AKHIR_NADYAADITAMA_1301154556('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TUGAS_PCD_AKHIR_NADYAADITAMA_1301154556.M with the given input arguments.
%
%      TUGAS_PCD_AKHIR_NADYAADITAMA_1301154556('Property','Value',...) creates a new TUGAS_PCD_AKHIR_NADYAADITAMA_1301154556 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Tugas_PCD_Akhir_nadyaaditama_1301154556_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Tugas_PCD_Akhir_nadyaaditama_1301154556_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Tugas_PCD_Akhir_nadyaaditama_1301154556

% Last Modified by GUIDE v2.5 16-May-2018 22:06:06

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Tugas_PCD_Akhir_nadyaaditama_1301154556_OpeningFcn, ...
                   'gui_OutputFcn',  @Tugas_PCD_Akhir_nadyaaditama_1301154556_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Tugas_PCD_Akhir_nadyaaditama_1301154556 is made visible.
function Tugas_PCD_Akhir_nadyaaditama_1301154556_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Tugas_PCD_Akhir_nadyaaditama_1301154556 (see VARARGIN)

% Choose default command line output for Tugas_PCD_Akhir_nadyaaditama_1301154556
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Tugas_PCD_Akhir_nadyaaditama_1301154556 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Tugas_PCD_Akhir_nadyaaditama_1301154556_OutputFcn(hObject, eventdata, handles) 
...
Horis = (0:255)';
figure
subplot(3,1,1), bar(Horis,list_histogramR), title('Histogram R');
subplot(3,1,2), bar(Horis,list_histogramG), title('Histogram G');
subplot(3,1,3), bar(Horis,list_histogramB), title('Histogram B');
    ...
    for i= 1:m
        for j= 1:n
            if mod(double(arr(i,j)),2)==0
                gbbaru(i,j)=((double(arr(i,j))+1))/2;
            else
                gbbaru(i,j) = double(arr(i,j))/2;
            end
        end
    end
...
gbbaru1 = uint8(gambarbaru);

figure
subplot(1,2,1),imshow(A);
subplot(1,2,2),imshow(gbbaru1);

imwrite(gbbaru1,'gambar_kompresi.jpg');
